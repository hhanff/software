...
# Funktionen
function usage {
    echo "This scripts stores the local IP address in a Dropbox folder."
...
if (( $# > 0 )) ; then
    echo "Kein Argument erforderlich.." >&2
    # usage $EXIT_ERROR
fi
sleep 30
#/bin/rm -rf /home/likewise-open/DFKI/hhanff/Dropbox/doc/Dies_und_das/IP_hhanff-u.txt
#/sbin/ifconfig > /home/likewise-open/DFKI/hhanff/Dropbox/doc/Dies_und_das/IP_hhanff-u.txt
exit $EXIT_SUCCESS
